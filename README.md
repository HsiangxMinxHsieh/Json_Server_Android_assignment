...
Beacause the assignment require,the data does not store in local database or BaseSharePreference,so I need get data in splash page:<BR>
...
after 4 second (assignment require), you will see the login page:<BR>
...
Then key in your account and password to login/signup. after 2.5 second(assignment require), you will see the result.<BR>
...
Of course, if your account is correct, but password is incorrect, you can not login.<BR>
...
By the way, the assignment require:"The input user account & user password cannot be empty. "<BR>
